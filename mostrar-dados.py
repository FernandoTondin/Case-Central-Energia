...
plt.savefig('plot-custo-usina-Carvao-24-custoXcarvao.png')

df = pd.read_csv('custo-usina-163-CarvaoXcarvao-mineral.csv',sep=',')
df.plot(x="carvao", y="custo1",kind="scatter")
plt.savefig('plot-custo-usina-Carvao-163-custoXcarvao.png')

df = pd.read_csv('custo-usina-167-CarvaoXcarvao-mineral.csv',sep=',')
df.plot(x="carvao", y="custo1",kind="scatter")
plt.savefig('plot-custo-usina-Carvao-167-custoXcarvao.png')